...
rtl.module("program",["System","Web","SysUtils","JS"],function () {
  ...
  this.AddTodo = function (Event) {
    ...
    var TaskText = "";
    Result = true;
    TaskText = $mod.InputText.value;
    if (TaskText === "") return Result;
    ...
    CheckBox["onchange"] = function (E) {
      ...
      if (CheckBox.checked) {
       ...
       else SpanText.style.setProperty("text-decoration","none");
      Result = true;
      return Result;
    };
    ...
    $mod.TodoList.appendChild(ListItem);
    $mod.InputText.value = "";
    $mod.InputText.focus();
    return Result;
  };
  this.HandleKeyPress = function (Event) {
    var Result = false;
    Result = true;
    if ((Event["keyCode"] == 13) || (Event["key"] == "Enter")) $mod.AddTodo(Event);
    return Result;
  };
  $mod.$main = function () {
    document.body.insertAdjacentHTML("afterbegin","<h1>Pascal Todo App</h1>");
    $mod.InputText = document.createElement("input");
    $mod.InputText.placeholder = "タスクを入力してEnter...";
    $mod.InputText["onkeypress"] = $mod.HandleKeyPress;
    document.body.appendChild($mod.InputText);
    $mod.AddButton = document.createElement("button");
    $mod.AddButton.innerText = "追加";
    $mod.AddButton["onclick"] = $mod.AddTodo;
    document.body.appendChild($mod.AddButton);
    $mod.TodoList = document.createElement("ul");
    document.body.appendChild($mod.TodoList);
  };
});
