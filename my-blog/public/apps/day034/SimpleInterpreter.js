...
rtl.module("RTLConsts",["System"],function () {
  "use strict";
  var $mod = this;
  $mod.$resourcestrings = {SArgumentMissing: {org: 'Missing argument in format "%s"'}, SInvalidFormat: {org: 'Invalid format specifier : "%s"'}, SInvalidArgIndex: {org: 'Invalid argument index in format: "%s"'}, SListCapacityError: {org: "List capacity (%s) exceeded."}, SListIndexError: {org: "List index (%s) out of bounds"}, SSortedListError: {org: "Operation not allowed on sorted list"}, SDuplicateString: {org: "String list does not allow duplicates"}, SErrFindNeedsSortedList: {org: "Cannot use find on unsorted list"}};
});
...
rtl.module("program",["System","SysUtils","Classes","JS","Web"],function () {
  "use strict";
  var $mod = this;
  this.ConsoleElement = null;
  this.SourceElement = null;
  this.PrintToConsole = function (Msg) {
    $mod.ConsoleElement.innerText = $mod.ConsoleElement.innerText + Msg + "\n";
  };
  rtl.createClass(this,"TInterpreter",pas.System.TObject,function () {
    this.$init = function () {
      pas.System.TObject.$init.call(this);
      this.FSource = "";
      this.FPos = 0;
    ...
    this.$final = function () {
      this.FVariables = undefined;
      pas.System.TObject.$final.call(this);
    };
    this.GetChar = function () {
      var Result = "\x00";
      if (this.FPos <= this.FSource.length) {
        Result = this.FSource.charAt(this.FPos - 1)}
       else Result = "\x00";
      return Result;
    };
    this.FetchToken = function () {
      ...
      Result = "";
      this.SkipSpaces();
      if (this.FPos > this.FSource.length) return Result;
      C = this.GetChar();
      if (C.charCodeAt() in rtl.createSet(null,65,90,null,97,122,95)) {
        while ((this.FPos <= this.FSource.length) && (this.FSource.charCodeAt(this.FPos - 1) in rtl.createSet(null,65,90,null,97,122,null,48,57,95))) {
          Result = Result + this.FSource.charAt(this.FPos - 1);
          this.FPos += 1;
        };
      } else if (C.charCodeAt() in rtl.createSet(null,48,57,46)) {
        while ((this.FPos <= this.FSource.length) && (this.FSource.charCodeAt(this.FPos - 1) in rtl.createSet(null,48,57,46))) {
          Result = Result + this.FSource.charAt(this.FPos - 1);
          this.FPos += 1;
        };
      } else {
    ...
    this.GetToken = function () {
      var Result = "";
      if (this.FLookAhead !== "") {
        Result = this.FLookAhead;
        this.FLookAhead = "";
      } else Result = this.FetchToken();
      return Result;
    };
    this.PeekToken = function () {
      var Result = "";
      if (this.FLookAhead === "") this.FLookAhead = this.FetchToken();
      Result = this.FLookAhead;
      return Result;
    };
    this.SkipSpaces = function () {
      while ((this.FPos <= this.FSource.length) && (this.FSource.charCodeAt(this.FPos - 1) in rtl.createSet(32,9,10,13))) this.FPos += 1;
    };
    this.ParseExpression = function () {
      ...
      while ((T === "+") || (T === "-")) {
        ...
        if (T === "+") {
         ...
         else Result = Result - this.ParseTerm();
        T = this.PeekToken();
      };
      return Result;
    };
    this.ParseTerm = function () {
      ...
      while ((T === "*") || (T === "/")) {
        ...
        if (T === "*") {
          Result = Result * Right}
         else if (Right !== 0) Result = Result / Right;
        T = this.PeekToken();
      };
      return Result;
    };
    this.ParseFactor = function () {
      ...
      if (T === "(") {
        ...
        if (T === "-") {
          Result = -this.ParseFactor()}
         else Result = this.ParseFactor();
      } else {
        T = this.GetToken();
        if (T === "") {
          Result = 0}
         else if ((T.length > 0) && (T.charCodeAt(0) in rtl.createSet(null,48,57,46))) {
          Result = pas.SysUtils.StrToFloatDef(T,0)}
         else Result = pas.SysUtils.StrToFloatDef(this.FVariables.GetValue(T),0);
      };
      return Result;
    };
    ...
    this.ExecuteOneStatement = function () {
      var Token = "";
      Token = this.GetToken();
      if (Token === "PRINT") {
        $mod.PrintToConsole(pas.SysUtils.FloatToStr(this.EvaluateExpression()))}
       else if (Token !== "") {
        if (this.PeekToken() === "=") this.GetToken();
        this.FVariables.SetValue(Token,pas.SysUtils.FloatToStr(this.EvaluateExpression()));
      };
    };
    this.SkipOneStatement = function () {
      var Token = "";
      Token = this.GetToken();
      if (Token === "PRINT") {
    ...
    this.ExecuteStatementWithToken = function (Token) {
      if (Token === "PRINT") {
        $mod.PrintToConsole(pas.SysUtils.FloatToStr(this.EvaluateExpression()))}
       else if (Token !== "") {
        if (this.PeekToken() === "=") this.GetToken();
    ...
    this.SkipStatementWithToken = function (Token) {
      if (Token === "PRINT") {
        this.EvaluateExpression()}
       else if (Token !== "") {
        if (this.PeekToken() === "=") this.GetToken();
    ...
    this.SkipUntilWEND = function () {
      var Token = "";
      do {
        Token = this.GetToken();
        if (Token === "WEND") return;
        if (Token === "WHILE") {
          this.EvaluateExpression();
          this.SkipUntilWEND();
        } else this.SkipStatementWithToken(Token);
      } while (!false);
    };
    this.DoWhileLoop = function () {
      var startOfLoop = 0;
      var condition = 0.0;
      var Token = "";
      startOfLoop = this.FPos;
      do {
        this.FPos = startOfLoop;
        this.FLookAhead = "";
        ...
        do {
          ...
          if (Token === "WHILE") {
            ...
            if (this.EvaluateExpression() !== 0) {
              this.ExecuteOneStatement();
          ...
          } else this.ExecuteStatementWithToken(Token);
        } while (!false);
      } while (!false);
    };
    this.Create$1 = function () {
      pas.System.TObject.Create.call(this);
      this.FVariables = pas.Classes.TStringList.$create("Create$1");
      this.FLookAhead = "";
      return this;
    };
    this.Destroy = function () {
      rtl.free(this,"FVariables");
      pas.System.TObject.Destroy.call(this);
    };
    this.Execute = function (ASource) {
      var Token = "";
      this.FSource = ASource;
      this.FPos = 1;
      while (this.FPos <= this.FSource.length) {
        Token = this.GetToken();
        if (Token === "PRINT") {
          $mod.PrintToConsole(pas.SysUtils.FloatToStr(this.EvaluateExpression()))}
         else if (Token === "IF") {
  ...
  this.OnRunClick = function (Event) {
    var Result = false;
    var Interpreter = null;
    Result = true;
    $mod.ConsoleElement.innerText = "";
    Interpreter = $mod.TInterpreter.$create("Create$1");
    try {
      Interpreter.Execute($mod.SourceElement.value);
    } finally {
      Interpreter = rtl.freeLoc(Interpreter);
    };
    return Result;
  };
  $mod.$main = function () {
    $mod.ConsoleElement = document.getElementById("console");
    $mod.SourceElement = document.getElementById("source");
    document.getElementById("runBtn").onclick = rtl.createSafeCallback($mod,"OnRunClick");
  };
});
