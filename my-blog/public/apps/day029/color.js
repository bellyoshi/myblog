...
rtl.module("program",["System","Web","SysUtils"],function () {
  ...
  this.HandleInput = function (Event) {
    $mod.ColorDisplay.style.setProperty("background-color",$mod.InputBox.value);
  };
  this.DocumentLoaded = function (Event) {
    ...
    $mod.InputBox = document.createElement("input");
    $mod.InputBox.setAttribute("type","text");
    $mod.InputBox.setAttribute("placeholder","#RRGGBB or color name");
    $mod.InputBox.style.setProperty("padding","10px");
    $mod.InputBox.style.setProperty("font-size","18px");
    Container.appendChild($mod.InputBox);
    $mod.ColorDisplay = document.createElement("div");
    $mod.ColorDisplay.style.setProperty("width","200px");
    $mod.ColorDisplay.style.setProperty("height","200px");
    $mod.ColorDisplay.style.setProperty("margin","20px auto");
    $mod.ColorDisplay.style.setProperty("border","2px solid #333");
    $mod.ColorDisplay.style.setProperty("transition","background-color 0.3s");
    $mod.ColorDisplay.style.setProperty("background-color","#ccc");
    Container.appendChild($mod.ColorDisplay);
    $mod.InputBox.addEventListener("input",rtl.createSafeCallback($mod,"HandleInput"));
  };
  $mod.$main = function () {
    window.addEventListener("load",rtl.createSafeCallback($mod,"DocumentLoaded"));
  };
});
